export default function NewArrivalsProducts() {
    ...
    <>
        ...
        <div className="container">
            ...
            <div className="box">
                ...
                <div className="img-box">
                    ...
                    <img src="images/Playstation/PS2-Console-wController(1).jpg" alt="" />
                </div>
            ...
            <div className="box">
                ...
                <div className="img-box">
                    ...
                    <img src="images/Playstation/PS2-Console-wController(2).jpg" alt="" />
                </div>
                <div className="detail-box">
                    <div className="text">
                    <h6>Men's Watch</h6>
        ...
        {/* New Arrivals end product section */}
    </>
    )
}